...
Chapt 28 pg 3:	Section 3: First Bullet is incorrect. For ideal transformer, with definitions as given in Chapt. 28 Section 2, |M| = Ns/Np x Lp = Np/Ns x Ls, or Ns^2/Np^2 = Lp/Ls
...
Chapt 44 pg 7: Eq. 44.9: t2 is defined as the time between t1 and the end of conversion (see fig 44.11b), so 44.9 SHOULD read Va=|Vref| x t2/t1
...
Chapt 44 prob 7: Error in form of solution: In 1msec, the counter must go through TWO full counts because of the way this kind of converter works (as carefully explained in the Reference Manual). Also, since reference is 5V, accuracy is 0.5*5Volts/Full Count, not 0.5*10Volts/Full Count
